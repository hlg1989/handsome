...
namespace handsome
{
    ...
    void event_loop::loop()
    {
        ...
        while(!m_quit){
            ...
            m_poll_return_time = m_poller->poll(kPollTimeMS, &m_active_channel);
            for(auto it = m_active_channel.begin(); it != m_active_channel.end(); ++it){
                (*it)->handle_event();
            }
