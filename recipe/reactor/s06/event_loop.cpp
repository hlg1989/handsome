...
namespace handsome{
    ...
    void event_loop::loop()
    {
        ...
        while(!m_quit){
            ...
            m_pool_return_time = m_poller->poll(kPollTimeMS, &m_active_channels);
    ...
    void event_loop::handle_read()
    {
        ...
        if(n != sizeof(one)){
            LOG_ERROR << "event_loop::handle_read() reads " << n << " bytes instead of 8 bytes";
        }
    }
