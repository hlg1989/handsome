...
namespace handsome{
    ...
    std::vector<std::pair<timestamp, timer *>> timer_queue::get_expired(timestamp now)
    {
    ...
    void timer_queue::reset(const std::vector<std::pair<timestamp, timer *>> &expired, timestamp now)
    {
